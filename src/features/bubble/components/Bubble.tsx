        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    // 'transform-origin': `right calc(50% + 120px)`,
                    transform: isBotOpened() ? 'scale3d(1, 1, 1) translateY(-50%)' : 'scale3d(0, 1, 1)',
                    'box-shadow': 'rgb(0 0 0 / 16%) 0px 5px 40px',
                    'background-color': bubbleProps.theme?.chatWindow?.backgroundColor || '#ffffff',
                    'z-index': 42424242
                }}
                class={
                    `fixed transform top-1/2 sm:right-24 rounded-lg w-full sm:w-[400px] max-h-[704px]` +
